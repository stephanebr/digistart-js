...
for (var i = 0; i <= nombres.length - 1; i++) {
    console.log("la valeur est" + " " + nombres[i])
}
...
for (var i = nombres.length - 1; i >=0; i--) {
    console.log("A l'inverse, la valeur est" + " " + nombres[i])
}
...
// une par une.
for (var i = 0; i <= nombres.length - 1; i= i+2 {
    console.log("la valeur d'indice pair est" + " " + nombres[i])
}
