...
console.log('mon prénom est ' + firstName + 'et est de type ' + typeof firstName);
console.log('mon age est ' + age + 'et est de type ' + typeof age);
console.log('j'aime le foot' + likeFootball + 'et est de type ' + boolean likeFootball);
console.log('otherstuff vaut ' + otherStuff + 'et est de type ' + typeof otherStuff);
// ------ TODO 3 ------
// TODO: ÉTAPE 1
